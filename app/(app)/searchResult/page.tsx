...
export default function SearchResultPage() {
  ...
  const handleSearch = useCallback((searchQuery: string) => {
    ...
    setActiveTab("All")
    try {
      router.push(`/searchResult?q=${encodeURIComponent(trimmed)}`)
    } catch {}
  ...
  return (
    <>
              ...
              {activeTab === "Videos" && (
                <>
                  <SearchSection title="ANIMATED VIDEOS" icon="🎬" itemCount={3}>
                    <VideoResultCard
                  ...
                  <SearchSection title="RECORDED CLASSES" icon="▶️" itemCount={2}>
                    <VideoResultCard
                      thumbnail="/recordedclass.webp"
                      title="Biology Complete Course - Chapter 1"
                      subtitle="45m"
                      watchCount="15.2 হাজার"
                      buttonText="Watch"
                      buttonVariant="primary"
                      query={searchState.query}
                    />
              ...
              {activeTab === "Notes" && (
                <>
                  <SearchSection title="SMART NOTES" icon="💬" itemCount={3}>
                    ...
                    <div className="flex items-center gap-4 bg-white rounded-2xl p-3 ring-1 ring-slate-200/50 shadow-sm">
                      ...
                      <div className="flex-grow space-y-1">
                        <h4 className="font-bold text-slate-800">Photosynthesis Complete Guide</h4>
                        <div className="flex items-center gap-1">
                          <svg className="w-3 h-3 text-slate-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                          </svg>
                          <p className="text-xs text-slate-500">2.1 হাজার</p>
                        </div>
                      </div>
                      <button className="px-4 py-2 bg-purple-600 text-white font-semibold rounded-full text-sm">View</button>
                    </div>
                    <div className="flex items-center gap-4 bg-white rounded-2xl p-3 ring-1 ring-slate-200/50 shadow-sm">
                      ...
                      <div className="flex-grow space-y-1">
                        <h4 className="font-bold text-slate-800">Cell Biology & Genetics</h4>
                        <div className="flex items-center gap-1">
                          <svg className="w-3 h-3 text-slate-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                          </svg>
                          <p className="text-xs text-slate-500">1.8 হাজার</p>
                        </div>
                      </div>
                      <button className="px-4 py-2 bg-purple-600 text-white font-semibold rounded-full text-sm">View</button>
                    </div>
                  ...
                  <SearchSection title="PDF NOTES" icon="📄" itemCount={3}>
                    <div className="flex items-center gap-4 bg-white rounded-2xl p-3 ring-1 ring-slate-200/50 shadow-sm">
                      <div className="relative flex-shrink-0 w-20 h-20 bg-slate-100 rounded-xl flex items-center justify-center">
                    ...
                    <div className="flex items-center gap-4 bg-white rounded-2xl p-3 ring-1 ring-slate-200/50 shadow-sm">
                      ...
                      <div className="flex-grow space-y-1">
                        <h4 className="font-bold text-slate-800">Human Anatomy Reference</h4>
                        <div className="flex items-center gap-1">
                          <svg className="w-3 h-3 text-slate-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                          </svg>
                          <p className="text-xs text-slate-500">1.4 হাজার</p>
                        </div>
                      </div>
                      <button className="px-4 py-2 bg-blue-600 text-white font-semibold rounded-full text-sm">Read</button>
                    </div>
                    <div className="flex items-center gap-4 bg-white rounded-2xl p-3 ring-1 ring-slate-200/50 shadow-sm">
                      ...
                      <div className="flex-grow space-y-1">
                        <h4 className="font-bold text-slate-800">Plant Biology Handbook</h4>
                        <div className="flex items-center gap-1">
                          <svg className="w-3 h-3 text-slate-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                          </svg>
                          <p className="text-xs text-slate-500">967</p>
                        </div>
                      </div>
                      <button className="px-4 py-2 bg-blue-600 text-white font-semibold rounded-full text-sm">Read</button>
                    </div>
              ...
              {activeTab === "Tests" && (
                <>
                  <SearchSection title="MCQ PRACTICE" icon="🧠" itemCount={3}>
                    <div className="flex items-center gap-4 bg-white rounded-2xl p-3 ring-1 ring-slate-200/50 shadow-sm">
                      <div className="relative flex-shrink-0 w-20 h-20 bg-slate-100 rounded-xl flex items-center justify-center">
                        <img 
                          src="/mcq.jfif" 
                    ...
                    <div className="flex items-center gap-4 bg-white rounded-2xl p-3 ring-1 ring-slate-200/50 shadow-sm">
                      ...
                      <div className="flex-grow space-y-1">
                        <h4 className="font-bold text-slate-800">Photosynthesis MCQ Test (25Q - 30m)</h4>
                        <div className="flex items-center gap-1">
                          <svg className="w-3 h-3 text-slate-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                          </svg>
                          <p className="text-xs text-slate-500">2.8 হাজার অংশগ্রহণ</p>
                        </div>
                      </div>
                      <button className="px-4 py-2 bg-purple-600 text-white font-semibold rounded-full text-sm">Start</button>
                    </div>
                    <div className="flex items-center gap-4 bg-white rounded-2xl p-3 ring-1 ring-slate-200/50 shadow-sm">
                      ...
                      <div className="flex-grow space-y-1">
                        <h4 className="font-bold text-slate-800">Cell Biology Practice (20Q - 25m)</h4>
                        <div className="flex items-center gap-1">
                          <svg className="w-3 h-3 text-slate-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                          </svg>
                          <p className="text-xs text-slate-500">1.9 হাজার অংশগ্রহণ</p>
                        </div>
                      </div>
                      <button className="px-4 py-2 bg-purple-600 text-white font-semibold rounded-full text-sm">Start</button>
                    </div>
                  ...
                  <SearchSection title="CQ / WRITTEN" icon="✍️" itemCount={2}>
                    <div className="flex items-center gap-4 bg-white rounded-2xl p-3 ring-1 ring-slate-200/50 shadow-sm">
                      <div className="relative flex-shrink-0 w-20 h-20 bg-slate-100 rounded-xl flex items-center justify-center">
                    ...
                    <div className="flex items-center gap-4 bg-white rounded-2xl p-3 ring-1 ring-slate-200/50 shadow-sm">
                      ...
                      <div className="flex-grow space-y-1">
                        <h4 className="font-bold text-slate-800">Human Anatomy CQ Test (45m)</h4>
                        <div className="flex items-center gap-1">
                          <svg className="w-3 h-3 text-slate-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                          </svg>
                          <p className="text-xs text-slate-500">1.2 হাজার অংশগ্রহণ</p>
                        </div>
                      </div>
                      <button className="px-4 py-2 bg-teal-600 text-white font-semibold rounded-full text-sm">Start</button>
                    </div>
                                    ...
                                    <SearchSection title="MODEL TESTS / LIVE EXAMS" icon="📊" itemCount={3}>
                    <div className="flex items-center gap-4 bg-white rounded-2xl p-3 ring-1 ring-slate-200/50 shadow-sm">
                      <div className="relative flex-shrink-0 w-20 h-20 bg-slate-100 rounded-xl flex items-center justify-center">
                    ...
                    <div className="flex items-center gap-4 bg-white rounded-2xl p-3 ring-1 ring-slate-200/50 shadow-sm">
                      ...
                      <div className="flex-grow space-y-1">
                        <h4 className="font-bold text-slate-800">Biology Admission Test Mock</h4>
                        <div className="flex items-center gap-1">
                          <svg className="w-3 h-3 text-slate-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                          </svg>
                          <p className="text-xs text-slate-500">3.7 হাজার অংশগ্রহণ</p>
                        </div>
                      </div>
                      <button className="px-4 py-2 bg-teal-600 text-white font-semibold rounded-full text-sm">Start</button>
      </div>
